...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/07 13:37:46 by gsharony          #+#    #+#             */
/*   Updated: 2020/10/07 13:37:47 by gsharony         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/philo_one.h"

int				init_mutex(t_philo_one *tmp, size_t size)
{
	size_t		i;

	i = 0;
	if (!(tmp->params->fork = malloc(sizeof(pthread_mutex_t*) * size)))
		return (1);
